...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon className="border  border-neutral-100 bg-neutral-50 size-4.5 w-4.5 h-4.5  flex justify-center items-center  text-neutral-500 rounded-full  pointer-events-none  shrink-0 translate-y-0.5 transition-transform duration-200" />
      </AccordionPrimitive.Trigger>
